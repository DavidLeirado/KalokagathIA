...
Two scrapers have been developed in Python, one automatic that extracts them from the API (still incomplete) and the other semi-automatic to extract additional texts from the web.
